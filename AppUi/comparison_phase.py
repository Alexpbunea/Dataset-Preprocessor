...
class Ui_comparison_phase(object):
    def setupUi(self, MainWindow):
        ...
        self.comparison_phase = QLabel("Comparison and visualization", self.background_label)
        self.comparison_phase.setAlignment(Qt.AlignCenter)
        self.comparison_phase.setStyleSheet("color: white;")
        self.overlay_layout.addWidget(self.comparison_phase, 0.5)  # 1/4 del espacio
    ...
    def _install_resize_event(self):
        ...
        def new_resize_event(event):
            ...
            self.comparison_phase.setStyleSheet(f"""
                color: white;
