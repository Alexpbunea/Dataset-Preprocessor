...
class Ui_data_phase(object):
    def setupUi(self, MainWindow):
        ...
        # Label data splitting phase
        self.data_phase = QLabel("Data splitting", self.background_label)
        self.data_phase.setAlignment(Qt.AlignCenter)
        self.data_phase.setStyleSheet("color: white;")
        self.overlay_layout.addWidget(self.data_phase, 0.5)  # 1/4 del espacio
    ...
    def _install_resize_event(self):
        ...
        def new_resize_event(event):
            ...
            self.data_phase.setStyleSheet(f"""
                color: white;
