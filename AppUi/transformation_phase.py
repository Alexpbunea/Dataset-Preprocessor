...
class Ui_transformation_phase(object):
    def setupUi(self, MainWindow):
        ...
        self.transformation_phase = QLabel("Transformation", self.background_label)
        self.transformation_phase.setAlignment(Qt.AlignCenter)
        self.transformation_phase.setStyleSheet("color: white;")
        self.overlay_layout.addWidget(self.transformation_phase, 0.5)  # 1/4 del espacio
    ...
    def _install_resize_event(self):
        ...
        def new_resize_event(event):
            ...
            self.transformation_phase.setStyleSheet(f"""
                color: white;
